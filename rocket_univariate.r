source("rocket_functions_univariate.r")
...
results_all <- data.frame(
   ...
   accuracy_mean <- numeric(length(dataset_names)),
   accuracy_standard_deviation <- numeric(length(dataset_names)),
   time_training_seconds <- numeric(length(dataset_names)),
   time_test_seconds <- numeric(length(dataset_names))
)
